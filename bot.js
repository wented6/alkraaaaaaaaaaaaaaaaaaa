...
if (message.content.startsWith(prefix + 'help')) {
    ...
    ❖ -vonline => Create Channel Voice Online | يسوي رووم فويس اونلاين
     ...
     ✴ Create Channel **suggestion** To Enable Command -sug OOps The prefix is !! 
     ===========================================================
...
client.on('guildCreate', guild => {
     ...
     .setURL('https://discordapp.com/oauth2/authorize?client_id=518375469356154880&permissions=8&scope=bot')
  .setDescription(`**
  New Server Add Light bot ✅
